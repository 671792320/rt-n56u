...
#define BOARD_PID		"ZTE_Q7"
#define BOARD_NAME		"ZTE_Q7"
#define BOARD_DESC		"ZTE Q7 Wireless Router"
...
#define BOARD_GPIO_BTN_RESET	74
#undef BOARD_GPIO_BTN_WPS
#undef  BOARD_GPIO_LED_ALL
#define BOARD_GPIO_LED_WIFI	9
#define BOARD_GPIO_LED_POWER	13	/* 13: red status, 9: blue status */
