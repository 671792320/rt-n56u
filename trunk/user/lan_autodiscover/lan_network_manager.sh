...
is_dhcp_target() { wanted="$1"; target_from_dhcp | grep -qx "$wanted"; }
clear_target_status() { runtime_set lan_discovery_status_target_network ""; runtime_set lan_discovery_status_target_ip ""; runtime_set lan_discovery_status_target_iface ""; }
