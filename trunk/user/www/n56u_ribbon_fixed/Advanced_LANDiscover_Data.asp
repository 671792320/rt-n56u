<% nvram_get_x("", "lan_discovery_status_if"); %>
|<% nvram_get_x("", "lan_discovery_status_role"); %>
|<% nvram_get_x("", "lan_discovery_status_ip"); %>
|<% nvram_get_x("", "lan_discovery_status_mac"); %>
|<% nvram_get_x("", "lan_discovery_status_link"); %>
|<% nvram_get_x("", "lan_discovery_status_dhcp"); %>
